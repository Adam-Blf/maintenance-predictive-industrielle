...
| **Rapport du projet** | ✅ | `reports/06/rapport_projet_data_science.pdf` (~30 pages, FPDF2) |
| **Support de Présentation** | ✅ | `reports/11/presentation.pptx` (24 slides charte EFREI) |
...
python scripts/06_generate_report.py # rapport PDF final → reports/06/
